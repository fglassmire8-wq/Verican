...
import { CONTACT_EMAIL, SITE_MARK } from "@/lib/site";

export function Footer() {
  return (
    <footer className="mt-auto border-t border-line">
      <div className="mx-auto max-w-6xl px-4 py-10 text-sm text-muted space-y-3">
        <p className="font-display text-lg sm:text-xl tracking-[0.14em] text-gold/80">{SITE_MARK}</p>
        <p>21+ only. The Green Vault does not sell cannabis. Reviews are user opinions.</p>
        <p>
